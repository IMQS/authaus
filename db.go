...
type UserStore interface {
	...
	SetConfig(passwordExpiry time.Duration) error
...
func (x *sanitizingUserStore) SetConfig(passwordExpiry time.Duration) error {
	return x.backend.SetConfig(passwordExpiry)
}
