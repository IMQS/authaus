...
type UserStore interface {
	...
	CreateIdentity(email, username, firstname, lastname, mobilenumber, telephonenumber, remarks string, created int64, createdby string, modified int64, modifiedby, password string, authUserType AuthUserType) (UserId, error) // Create a new identity. If the identity already exists, then this must return ErrIdentityExists.
	UpdateIdentity(userId UserId, email, username, firstname, lastname, mobilenumber, telephonenumber, remarks string, modified int64, modifiedby string, authUserType AuthUserType) error      // Update an identity. Change email address or name etc.
...
func (x *dummyUserStore) CreateIdentity(email, username, firstname, lastname, mobilenumber, telephonenumber, remarks string, created int64, createdby string, modified int64, modifiedby, password string, authUserType AuthUserType) (UserId, error) {
	x.usersLock.Lock()
	defer x.usersLock.Unlock()
	var user *dummyUser
	...
	if user == nil {
		...
		x.users[userId] = &dummyUser{userId, email, username, firstname, lastname, mobilenumber, telephonenumber, remarks, created, createdby, modified, modifiedby, password, "", false, authUserType}
		return userId, nil
	} else {
...
func (x *dummyUserStore) UpdateIdentity(userId UserId, email, username, firstname, lastname, mobilenumber, telephonenumber, remarks string, modified int64, modifiedby string, authUserType AuthUserType) error {
	x.usersLock.Lock()
	defer x.usersLock.Unlock()
...
func (x *sanitizingUserStore) CreateIdentity(email, username, firstname, lastname, mobilenumber, telephonenumber, remarks string, created int64, createdby string, modified int64, modifiedby, password string, authUserType AuthUserType) (UserId, error) {
	...
	return x.backend.CreateIdentity(email, username, firstname, lastname, mobilenumber, telephonenumber, remarks, created, createdby, modified, modifiedby, password, authUserType)
}

func (x *sanitizingUserStore) UpdateIdentity(userId UserId, email, username, firstname, lastname, mobilenumber, telephonenumber, remarks string, modified int64, modifiedby string, authUserType AuthUserType) error {
	email = cleanIdentity(email)
	if len(email) == 0 && len(username) == 0 {
		return ErrIdentityEmpty
	}
	return x.backend.UpdateIdentity(userId, email, username, firstname, lastname, mobilenumber, telephonenumber, remarks, modified, modifiedby, authUserType)
}
